...
class ProviderAdmin(admin.ModelAdmin):
    ...
    list_filter = ('statut', 'disponible', 'ville')
    search_fields = ('nom', 'specialite', 'ville', 'bio', 'photo_portrait_url', 'cni_url')
    raw_id_fields = ('user',)
    actions = ['approve_providers', 'refuse_providers', 'toggle_availability']
...
class ReservationAdmin(admin.ModelAdmin):
    ...
    list_filter = ('statut', 'payment_type', 'mobile_money_operator', 'cash_flow_status')
...
class DisputeAdmin(admin.ModelAdmin):
    list_display = ('reference', 'motif', 'client', 'prestataire', 'priorite', 'decision')
...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ('nom', 'icone_slug', 'ordre_affichage', 'services', 'reservations', 'actif')
    list_filter = ('actif',)
...
class SystemSettingAdmin(admin.ModelAdmin):
    list_display = ('id', 'commission', 'auto_validation', 'maintenance', 'mode_paiement')
...
admin.site.index_title = 'CRUD : prestataires, réservations, paiements, contenu…'

...
urlpatterns = [
    ...
    path('api/public/payment-methods/', api_public_payment_methods, name='api-public-payment-methods'),
    ...
    path('api/client/actualites/<int:pk>', api_client_actualite_detail, name='api-client-actualite-detail'),
    path('api/client/prestataires', api_client_prestataires, name='api-client-prestataires'),
    path('api/client/conversations', api_client_conversations, name='api-client-conversations'),
    path('api/client/reservations', api_client_create_reservation, name='api-client-reservations-create'),
    path(
    ...
    path('api/messages/<int:message_id>/delete', api_client_message_delete, name='api-message-delete'),
    path('api/messages/unread-total', api_messages_unread_total, name='api-messages-unread-total'),
    path('api/prestataire/register', api_prestataire_register, name='api-prestataire-register'),
    path('api/prestataire/requests', api_prestataire_requests, name='api-prestataire-requests'),
    path('api/prestataire/requests/<str:reference>/decision', api_prestataire_decide_request, name='api-prestataire-decision'),
    path(
    ...
    path('api/prestataire/earnings', api_prestataire_earnings, name='api-prestataire-earnings'),
    path('api/prestataire/ratings', api_prestataire_ratings, name='api-prestataire-ratings'),
    path('api/prestataire/me', api_prestataire_me, name='api-prestataire-me'),
    path('api/prestataire/conversations', api_prestataire_conversations, name='api-prestataire-conversations'),
    # ── Disponibilité prestataire ────────────────────────────────────────────
    path('api/prestataire/availability/', api_prestataire_availability, name='api-prestataire-availability'),
    path('api/prestataire/availability/slots/', api_prestataire_availability_crud, name='api-prestataire-availability-crud'),
    path('api/prestataire/unavailability/', api_prestataire_unavailability_crud, name='api-prestataire-unavailability-crud'),
    path('api/prestataire/stats/', api_prestataire_stats, name='api-prestataire-stats'),
    # ── CinetPay Mobile Money ────────────────────────────────────────────────
    path('api/paiements/cinetpay/initiate/', cinetpay_initiate, name='cinetpay-initiate'),
    path('api/paiements/cinetpay/status/<str:transaction_id>/', cinetpay_status, name='cinetpay-status'),
    path('api/paiements/cinetpay/webhook/', cinetpay_webhook, name='cinetpay-webhook'),
    # ── Admin — Actions bulk, audit log, export CSV ──────────────────────────
    path('api/admin/prestataires/bulk-action/', api_admin_bulk_provider_action, name='admin-bulk-action'),
    ...
    path('api/client/reservations/list', api_client_reservations_list, name='api-client-reservations-list'),
    path('api/client/reservations/<str:reference>/detail', api_client_reservation_detail, name='api-client-reservation-detail'),
    path('api/client/reservations/<str:reference>/cancel', api_client_cancel_reservation, name='api-client-reservation-cancel'),
    path('api/client/reservations/<str:reference>/dispute', api_client_open_dispute, name='api-client-reservation-dispute'),

    # ── v2 — Auth : reset mot de passe + refresh token + vérif email ─────────
    path('api/auth/forgot-password', api_auth_forgot_password, name='api-auth-forgot-password'),
    path('api/auth/reset-password', api_auth_reset_password, name='api-auth-reset-password'),
    path('api/auth/refresh', api_auth_refresh_token, name='api-auth-refresh'),
    path('api/auth/verify-email/<str:token>', api_auth_verify_email, name='api-auth-verify-email'),

    # ── v2 — Profil + Portfolio prestataire ──────────────────────────────────
    path('api/prestataire/profile', api_prestataire_profile_update, name='api-prestataire-profile-update'),
    path('api/prestataire/portfolio', api_prestataire_portfolio, name='api-prestataire-portfolio'),
    path('api/prestataire/portfolio/<int:idx>', api_prestataire_portfolio_delete, name='api-prestataire-portfolio-delete'),
    path('api/prestataire/reservations/<str:reference>/rate-client', api_prestataire_rate_client, name='api-prestataire-rate-client'),

    # ── v2 — Notifications persistantes ──────────────────────────────────────
    path('api/notifications', api_user_notifications, name='api-user-notifications'),
    path('api/notifications/mark-read', api_user_notifications_mark_read, name='api-user-notifications-mark-read'),

    # ── v2 — Portfolio public prestataire ────────────────────────────────────
    path('api/client/prestataires/<int:provider_id>/portfolio', api_provider_portfolio_public, name='api-provider-portfolio-public'),

    # ── v2 — Admin push broadcast ────────────────────────────────────────────
    path('api/admin/push-broadcast', api_admin_push_broadcast, name='api-admin-push-broadcast'),
    ...
    path('api/prestataire/disputes/', api_prestataire_disputes, name='api-prestataire-disputes'),
]

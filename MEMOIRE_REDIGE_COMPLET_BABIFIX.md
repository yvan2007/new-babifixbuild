...
1.2. Les plateformes de mise en relation existantes : étude comparative et limites .. 13
   1.2.5. Analyse des forces concurrentielles — Modèle de Porter (5 forces) .. 17
1.3. Le modèle économique et la proposition de valeur de BABIFIX .. 20
   1.3.1. Le modèle économique et le schéma de revenus .. 20
1.4. Impact Socio-Économique — BABIFIX comme Levier de Transformation .. 25
...
| Tableau 8 | Tableau des besoins fonctionnels (BF-01 à BF-14) | [p.] |
...
| Mobile Money | Service de paiement mobile en Côte d'Ivoire — trois opérateurs historiques : Orange Money, MTN Moov Money, Moov Africa ; et Wave, nouvel entrant à très forte croissance |
...
Les résultats présentés montrent un système fonctionnel intégrant : le cycle complet de validation des prestataires (quatorze besoins fonctionnels BF-01 à BF-14), le chat lié aux réservations avec badge de messages non lus, la diffusion temps réel des prestataires approuvés, la section actualités et le tableau de bord analytique avec affichage des paiements en FCFA. La plateforme intègre également un **système de vérification d'identité KYC à trois niveaux** — analyse qualité d'image par traitement d'image (Pillow), détection et comparaison faciale par vision artificielle (OpenCV), vérification optionnelle contre la base gouvernementale ivoirienne (Smile Identity) — produisant un score de confiance de 0 à 100 avec décision automatique, une **authentification sociale** (Google Sign-In et Sign in with Apple) avec vérification côté serveur par JWT, un système de **vérification d'email** et de réinitialisation de mot de passe, un **système d'icônes de catégories piloté par le serveur** : chaque catégorie Django stocke un champ d'URL d'icône retournant l'adresse absolue d'un fichier SVG servi statiquement, rendu dans l'application Flutter sans aucun mapping local, ainsi qu'une section « Notifications intelligentes » et un **bandeau de consentement aux cookies** conforme au RGPD sur le site vitrine. Ce travail constitue une contribution à la documentation des architectures hybrides REST + temps réel en écosystème Django / Flutter appliquées aux marchés émergents d'Afrique de l'Ouest.
...
Results demonstrate a functional system incorporating: the complete provider validation cycle, reservation-linked chat with unread message badges, real-time broadcasting of approved providers, a news section, and an analytical dashboard with FCFA payment display. The platform additionally integrates a **three-level KYC identity verification engine** — image quality analysis (Pillow), face detection and comparison (OpenCV), and optional verification against the Ivorian government database (Smile Identity) — producing a 0-to-100 confidence score with automatic decision-making; **social authentication** (Google Sign-In and Sign in with Apple) with server-side JWT verification; an **email verification** and password reset workflow; a **server-driven category icon system** where each Django category stores an icon URL field rendered in the Flutter app without any local mapping; an "Intelligent Notifications" showcase section; and a **GDPR-compliant cookie consent banner** on the website. This work contributes to the documentation of hybrid REST + real-time architectures in the Django / Flutter ecosystem applied to West African emerging markets.
...
En Afrique de l'Ouest, et particulièrement en Côte d'Ivoire, cette transformation numérique s'opère dans un contexte singulier. Le secteur des services à domicile — plomberie, électricité, ménage, jardinage, cours particuliers — est structurellement dominé par l'économie informelle. Plus de 90 % des artisans et prestataires exercent sans cadre formel, ce qui génère une asymétrie d'information préjudiciable tant aux clients qu'aux prestataires eux-mêmes : absence de garantie de qualité, opacité des tarifs, impossibilité pour le client d'évaluer la fiabilité d'un intervenant avant de lui ouvrir sa porte. Parallèlement, la Côte d'Ivoire connaît une adoption massive du Mobile Money — portée par trois opérateurs historiques (Orange Money, MTN Moov Money, Moov Africa) et un nouvel entrant en forte croissance (Wave) — avec plus de 24 millions de comptes actifs et un volume de transactions annuelles dépassant 40 000 milliards de FCFA (SocialNetLink 2025 ; SikaFinance 2024). Cette infrastructure de paiement mobile constitue un levier considérable pour la digitalisation des échanges informels.
...
L'un des atouts distinctifs du marché ivoirien réside dans sa maturité en matière de paiement mobile. La Côte d'Ivoire figure parmi les pays africains les plus avancés dans l'adoption du Mobile Money. Selon les données récentes, plus de **70 % de la population adulte** utilise au moins un service de paiement mobile, et le pays recense **24 millions de comptes actifs** de Mobile Money. Le volume des transactions annuelles dépasse **40 000 milliards de FCFA**, pour un revenu cumulé des **trois opérateurs historiques principaux** — Orange Money, MTN Moov Money et Moov Africa — de 24,5 milliards de FCFA (SikaFinance 2024). À ces trois acteurs établis s'ajoute **Wave**, nouvel entrant sur le marché ivoirien mais en très forte progression, notamment auprès de la clientèle jeune et urbaine grâce à ses frais de transfert réduits à zéro. L'inclusion financière totale — intégrant le Mobile Money — atteint **82 %** de la population, alors que le taux de bancarisation stricto sensu ne dépasse pas 26 % (Banque mondiale ; Agence Ecofin 2023).
...
| Nombre de comptes actifs (total Mobile Money) | 24 millions | SocialNetLink 2025 |
| Volume transactions annuelles | > 40 000 mds FCFA | SikaFinance 2024 |
| Revenu cumulé opérateurs historiques (Orange, MTN Moov, Moov Africa) | 24,5 mds FCFA | SikaFinance 2024 |
| Wave — part de marché en croissance (nouvel entrant) | En forte progression | SikaFinance 2024 |
...
Ce contexte est fondamental pour comprendre l'opportunité que représente BABIFIX : dans un marché où la grande majorité des actifs n'ont pas de compte bancaire mais utilisent le Mobile Money au quotidien, toute plateforme numérique de services doit impérativement intégrer les paiements des trois opérateurs historiques (Orange Money, MTN Moov Money, Moov Africa) ainsi que Wave — dont l'adoption rapide, en particulier chez les 18-35 ans, en fait un canal incontournable — pour être pleinement viable. C'est l'un des éléments différenciateurs majeurs de BABIFIX par rapport aux solutions internationales qui ne supportent que les cartes bancaires.
...
### 1.2.5. Analyse des forces concurrentielles — Modèle de Porter (5 forces)

L'analyse des cinq forces compétitives de Michael Porter, appliquée au marché des plateformes de services à domicile en Côte d'Ivoire, révèle un environnement structurellement favorable à l'émergence d'un acteur dominant. Elle valide simultanément le positionnement stratégique de BABIFIX et ses priorités de court terme.

```
                    ┌──────────────────────────────────────┐
                    │      NOUVEAUX ENTRANTS                │
                    │  Menace : MODÉRÉE ⚡                  │
                    │  Faibles barrières capitales          │
                    │  Fortes barrières de confiance (KYC)  │
                    └──────────────┬───────────────────────┘
                                   │
         ┌─────────────────────────▼──────────────────────────┐
         │                                                     │
...
│  (Prestataires)   │◄──►│   SECTORIELLE    │◄──►│  (Particuliers)      │
│  Menace : FAIBLE  │    │   Menace : FAIBLE│    │  Menace : MODÉRÉE    │
│  Marché atomisé   │    │   Aucun dominant │    │  Sensibilité prix    │
│  (100 000+        │    │   local établi   │    │  mais confiance      │
│   artisans)       │    │                  │    │  primordiale         │
└───────────────────┘    └──────────────────┘    └──────────────────────┘
                                   │
                    ┌──────────────▼───────────────────────┐
                    │      SUBSTITUTS                       │
                    ...
                    │  Embauche directe sans garantie       │
                    └──────────────────────────────────────┘
```

**Force 1 — Menace des nouveaux entrants : MODÉRÉE**

Les barrières financières à l'entrée restent relativement accessibles : une application mobile et un backend Django/Flutter peuvent être développés en moins de six mois avec un budget inférieur à 5 millions de FCFA. En revanche, les barrières de confiance et d'adoption sont structurellement élevées. Une plateforme de services à domicile requiert une **masse critique de prestataires vérifiés** avant de devenir attractive pour les clients — phénomène dit du « problème de la poule et de l'œuf » propre aux marketplaces bifaces. L'avance de BABIFIX sur la vérification KYC tri-niveaux (Pillow / OpenCV / Smile Identity), le workflow d'approbation administratif et l'historique de notation accumulé constitue un avantage de premier entrant structurellement difficile à répliquer rapidement. Les effets de réseau — plus de prestataires vérifiés génèrent plus de clients, qui attirent plus de prestataires — renforcent cette position dès qu'une masse critique est atteinte dans le Grand Abidjan.

**Force 2 — Pouvoir de négociation des prestataires (fournisseurs) : FAIBLE**

Le marché des artisans et prestataires de services informels en Côte d'Ivoire est extrêmement atomisé : plusieurs centaines de milliers de travailleurs opèrent de manière indépendante, sans organisation syndicale structurée ni association professionnelle représentative. Cette fragmentation réduit considérablement leur pouvoir de négociation individuel face à la plateforme. Cependant, les prestataires hautement qualifiés (électriciens certifiés, plombiers agréés) constituent un segment de niche dont BABIFIX dépend pour maintenir sa réputation de qualité de service, créant une dépendance asymétrique qu'il convient de gérer par des mécanismes de fidélisation (commissions préférentielles, outils de gestion dédiés, badge Premium).

**Force 3 — Pouvoir de négociation des clients : MODÉRÉ**

Les clients disposent théoriquement d'un fort pouvoir de substitution : ils peuvent à tout moment recourir au bouche-à-oreille, aux réseaux sociaux ou à l'embauche directe. Toutefois, la valeur perçue de la vérification des prestataires, de la traçabilité des interventions et de la résolution structurée des litiges constitue une **barrière de sortie psychologique** importante une fois que l'utilisateur a expérimenté la sécurité offerte par la plateforme. La sensibilité au prix demeure réelle dans un marché à revenus médians modérés, ce qui justifie une stratégie de commission compétitive (12 %) inférieure aux standards internationaux (15-20 % pour TaskRabbit).

**Force 4 — Menace des produits de substitution : ÉLEVÉE**

Le principal concurrent de BABIFIX n'est pas une autre plateforme numérique mais le **comportement informel lui-même** — groupes WhatsApp de quartier, recommandations de voisins, artisans recrutés à l'entrée des marchés, annonces sur les panneaux de quartier. Ces substituts présentent un coût de switching quasi-nul pour des utilisateurs disposant d'un réseau social de proximité actif. La stratégie de BABIFIX pour neutraliser cette menace repose sur la **valeur irréplicable de la garantie** : vérification d'identité KYC, système de notation transparent, gestion formelle des litiges avec recours administratif — des éléments structurellement absents du marché informel. L'éducation des utilisateurs à la valeur de cette garantie constitue le premier axe de la stratégie marketing.

**Force 5 — Intensité de la rivalité intra-sectorielle : FAIBLE — Opportunité majeure**

Le marché ivoirien des plateformes de services à domicile ne compte aujourd'hui aucun acteur dominant. Les solutions existantes (Yako Services, Gombo, OnDjossi, Home Services CI) restent embryonnaires, sans système intégré complet alliant validation, messagerie et paiements FCFA. Cette **absence de leader établi** constitue une fenêtre d'opportunité stratégique de première importance que BABIFIX doit exploiter par un déploiement accéléré et une conquête de la masse critique dans le Grand Abidjan avant l'arrivée potentielle de plateformes africaines continentales disposant de ressources importantes (Lynk, SweepSouth, ou un pivot d'acteurs régionaux comme Jumia Services).

**Tableau X.1 — Synthèse stratégique de l'analyse de Porter**

| Force compétitive | Intensité | Impact pour BABIFIX | Réponse stratégique prioritaire |
|---|---|---|---|
| Nouveaux entrants | Modérée | Avantage premier entrant à consolider | Accélérer acquisition prestataires et notoriété |
| Prestataires (fournisseurs) | Faible | Liberté de fixation des conditions | Fidéliser par revenus stables et outils pro |
| Clients (acheteurs) | Modérée | Sensibilité prix à gérer | Commission compétitive + valeur garantie KYC |
| Substituts informels | Élevée | Concurrence comportementale structurelle | Éduquer sur la valeur de la confiance numérique |
| Rivalité sectorielle | Faible | Opportunité de leadership de marché | Time-to-market et couverture géographique rapide |

---

## 1.3. Le modèle économique et la proposition de valeur de BABIFIX

### 1.3.1. Le modèle économique et le schéma de revenus

BABIFIX s'appuie sur un modèle économique mixte à revenus diversifiés, structuré en trois phases de déploiement progressif. Ce modèle s'inspire des meilleures pratiques des plateformes de services à l'échelle mondiale (TaskRabbit, Lynk) tout en étant intégralement adapté aux réalités du marché FCFA/UEMOA.

**Schéma de flux financier BABIFIX**

```
┌──────────────────────────────────────────────────────────────────────────────┐
│                         FLUX FINANCIER BABIFIX                               │
│                                                                              │
│  CLIENT                      BABIFIX                      PRESTATAIRE        │
│    │                            │                               │            │
│    │──── 12 000 FCFA ──────────►│                               │            │
│    │     (Mobile Money)         │                               │            │
│    │                            │──── 10 200 FCFA (85%) ───────►│            │
...
│    │                            │     (commission BABIFIX)       │            │
│    │                            │                               │            │
│    │                            │──── ~240 FCFA (2%) ──────────►│ Opérateur  │
│    │                            │     (frais passerelle)         │ Mobile     │
│    │                            │                               │            │
│    │                            │  MARGE NETTE ≈ 13%            │            │
│    │                            │  (~1 560 FCFA/transaction)    │            │
└──────────────────────────────────────────────────────────────────────────────┘
```

**Tableau X.2 — Sources de revenus BABIFIX — Modèle économique détaillé**

| Source de revenus | Mécanisme | Montant estimatif | Phase de déploiement |
|---|---|---|---|
| **Commission sur transactions** | 12-15 % prélevés sur chaque réservation complétée, alignant les intérêts de la plateforme et des prestataires | Variable selon volume | **Phase 1 — Lancement** |
| **Abonnement prestataire Premium** | Accès aux statistiques avancées, badge « Vérifié BABIFIX », priorité dans les résultats, outils de gestion d'agenda | 5 000 – 15 000 FCFA/mois | **Phase 2 — Croissance** |
| **Mise en avant sponsorisée** | Slots payants pour apparaître en tête des résultats de recherche par catégorie ou zone géographique | 10 000 – 50 000 FCFA/mois | **Phase 2 — Croissance** |
| **Publicité locale ciblée** | Annonces de marques locales partenaires (fournisseurs de matériaux, outillage, assurances) auprès de la communauté de prestataires | CPM/CPC en FCFA | **Phase 3 — Échelle** |
| **Données analytiques B2B** | Rapports sectoriels sur la demande géolocalisée de services (marchés de niche pour banques, IMF, assureurs) | Sur devis | **Phase 3 — Échelle** |

**Tableau X.3 — Projection financière indicative — Scénario conservateur (An 1, Grand Abidjan)**

| Indicateur | Hypothèse de calcul | Valeur projetée |
|---|---|---|
| Prestataires actifs validés | Déploiement progressif sur 12 mois | 500 prestataires |
| Missions réalisées/prestataire/mois | Moyenne marché services à domicile | 8 missions |
| Volume mensuel de missions | 500 × 8 | 4 000 missions/mois |
| Montant moyen par mission | Tarif médian service à domicile Abidjan | 12 000 FCFA |
| Volume mensuel de transactions | 4 000 × 12 000 FCFA | 48 000 000 FCFA |
| Commission BABIFIX (12 %) | Revenu brut mensuel | 5 760 000 FCFA |
| Coûts opérationnels estimés | Infrastructure + support + modération | ~2 000 000 FCFA |
| **Résultat opérationnel mensuel** | **Marge opérationnelle ≈ 35 %** | **~3 760 000 FCFA** |
| **Chiffre d'affaires annuel projeté** | **12 mois × revenu brut** | **~69 000 000 FCFA** |

*Note : ces projections constituent un exercice de modélisation à des fins de démonstration de viabilité et ne constituent pas un engagement financier. Les hypothèses retenues sont volontairement conservatrices.*

### 1.3.2. La proposition de valeur différenciante

La proposition de valeur repose sur trois piliers :

**1. La gouvernance et la confiance** : tout prestataire soumet sa CNI lors de l'inscription. L'administrateur valide ou refuse avec un motif explicite. Le prestataire peut corriger et resoumettre sans recréer de compte. Ce workflow en trois états — *en attente*, *accepté*, *refusé avec motif* — est le cœur de la différenciation de BABIFIX.
...
## 1.4. Impact Socio-Économique — BABIFIX comme Levier de Transformation

### 1.4.1. Inclusion financière et formalisation de l'économie informelle

L'un des impacts potentiels les plus profonds de BABIFIX dépasse le cadre strictement commercial : en dotant les prestataires informels d'une **identité numérique vérifiée** et d'un **historique traçable de prestations**, la plateforme constitue un vecteur d'inclusion financière à fort effet de levier. Un prestataire actif sur BABIFIX pendant six mois dispose d'un historique de transactions documenté, horodaté et certifié — condition sine qua non pour accéder à des produits financiers formels (crédit professionnel, microcrédit, assurance) généralement inaccessibles aux travailleurs informels.

Ce mécanisme a été observé et validé à grande échelle par des plateformes comparables sur le continent africain. Lynk au Kenya, qui connecte des travailleurs informels kenyans à des employeurs, a permis à plus de 1 300 prestataires de constituer leur premier profil financier traçable, ouvrant la voie à des prêts professionnels accordés par des institutions de microfinance partenaires — une évolution qualifiée de « formalisation par le numérique » par les chercheurs de l'Université de Nairobi (The Conversation, 2020). BABIFIX ambitionne de jouer un rôle analogue dans l'écosystème ivoirien, en établissant à terme des partenariats avec les institutions de microfinance (IMF) de la zone UEMOA pour valoriser les profils de prestataires actifs.

Dans un contexte où **74 % de la population adulte ivoirienne n'a pas accès aux services bancaires formels** mais où 82 % utilisent le Mobile Money, BABIFIX exploite précisément cette infrastructure existante pour créer une passerelle vers la formalité — sans exiger de compte bancaire préalable.

### 1.4.2. Création d'emplois et structuration du secteur artisanal

BABIFIX génère de la valeur économique à plusieurs niveaux distincts et cumulatifs :

**Emplois directs créés par la startup** : l'équipe opérationnelle — modérateurs de contenu, gestionnaires de litiges, agents de support client bilingue (français/langues locales), développeurs mobiles — constitue un premier cercle d'emplois qualifiés formels créés directement par la startup et localisés en Côte d'Ivoire.

**Revenus additionnels pour les prestataires** : pour un prestataire réalisant en moyenne 8 missions par mois à 12 000 FCFA chacune, l'accès à BABIFIX représente un revenu mensuel brut de 96 000 FCFA supplémentaires. Après commission de la plateforme (12 %), le prestataire perçoit environ 84 480 FCFA — soit l'équivalent d'environ 1,2 SMIG ivoirien additionnel, sans les contraintes d'un emploi salarié.

**Effet de formalisation progressive** : en exigeant la soumission d'une pièce d'identité officielle et en produisant des reçus de transaction numériques, BABIFIX crée des incitations économiques à la structuration juridique — obtention d'un document professionnel, inscription à une chambre des métiers, déclaration fiscale simplifiée.

**Tableau X.4 — Indicateurs d'impact socio-économique projetés (An 2 — BABIFIX Grand Abidjan)**

| Dimension d'impact | Indicateur clé | Valeur projetée | Base de référence |
|---|---|---|---|
| **Formalisation numérique** | Prestataires avec identité numérique vérifiée | 1 000 | Objectif plateforme An 2 |
| **Inclusion financière** | Prestataires disposant d'un historique transaction accédant à des produits financiers | 300-400 | Partenariats IMF |
| **Revenus additionnels** | Gain mensuel moyen par prestataire actif (après commission) | +84 000 FCFA/mois | Simulation 8 missions/mois |
| **Emplois directs** | Postes créés au sein de BABIFIX (équipe, support, tech) | 15 à 20 | Plan de recrutement |
| **Réduction risque** | Litiges évités grâce à la vérification KYC vs. marché informel | -60 % | Estimation sectorielle |
| **Couverture géographique** | Communes d'Abidjan couvertes par un réseau de prestataires validés | 10 communes | Déploiement progressif |

### 1.4.3. Contribution à la Stratégie Nationale de Transformation Numérique

Le développement de BABIFIX s'inscrit en cohérence directe avec les orientations de la **Stratégie Nationale de l'Économie Numérique de la Côte d'Ivoire (SEN-CI 2020-2025)** et les objectifs de l'**Agenda Digital Côte d'Ivoire 2030**, qui fixent pour ambition de faire de la Côte d'Ivoire un hub numérique de référence en Afrique de l'Ouest, en augmentant le taux d'inclusion financière, en numérisant les secteurs économiques informels et en développant l'écosystème startup ivoirien.

BABIFIX contribue concrètement à ces objectifs selon quatre axes :

1. **Numérisation d'un secteur structurellement informel** : les services à domicile — représentant un marché estimé à plusieurs centaines de milliards de FCFA annuellement — sont jusqu'à présent demeurés hors de portée des plateformes digitales. BABIFIX opère cette transition numérique avec des solutions adaptées au contexte local.

2. **Valorisation des infrastructures de paiement mobile existantes** : en s'appuyant sur les trois opérateurs historiques (Orange Money, MTN Moov Money, Moov Africa) et sur Wave, nouvel entrant en très forte progression — ensemble utilisés par plus de 70 % des adultes ivoiriens —, BABIFIX ne crée pas une rupture technologique mais s'appuie sur un écosystème de confiance déjà ancré dans les habitudes de la population.

3. **Formation numérique implicite** : chaque prestataire qui s'inscrit sur BABIFIX apprend à gérer un profil en ligne, à communiquer via une messagerie intégrée, à consulter ses statistiques de revenus — compétences numériques transférables à d'autres contextes professionnels.

4. **Génération de données économiques sectorielles** : les données agrégées et anonymisées produites par la plateforme (demande géolocalisée par type de service, prix du marché, flux de transactions par zone) constituent une ressource précieuse pour les décideurs publics, les investisseurs et les institutions de développement opérant dans la région.

> *« Une plateforme qui transforme un artisan informel en micro-entrepreneur numérique vérifiable ne crée pas seulement de la valeur commerciale — elle construit les fondations d'une économie de confiance. »*
...
La vérification d'identité des prestataires est le mécanisme de sécurité le plus visible par les utilisateurs. Des acteurs comme Amazon Home Services exigent des prestataires une vérification d'antécédents, une licence professionnelle et une assurance (Amazon Sellers Lawyer 2024). BABIFIX adopte une approche proportionnée au contexte ivoirien, organisée en trois niveaux complémentaires :

**Niveau 1 — Vérification documentaire automatique** : à la soumission du dossier, le système contrôle automatiquement la cohérence des documents fournis. La bibliothèque Pillow vérifie la résolution minimale, la luminosité et la netteté de chaque image. Un algorithme de hachage SHA-256 est calculé sur chaque document pour détecter toute altération ultérieure. La plateforme exige trois documents distincts : recto et verso de la CNI, ainsi qu'un selfie du prestataire tenant sa CNI à la main — rendant l'usurpation d'identité significativement plus difficile.

**Niveau 2 — Détection faciale par vision artificielle** : si la bibliothèque OpenCV est disponible sur le serveur, le moteur détecte automatiquement la présence d'un visage humain sur chaque document. Un algorithme de comparaison de descripteurs (ORB — *Oriented FAST and Rotated BRIEF*) mesure la similarité entre le visage du selfie et la photographie figurant sur la CNI, produisant un indice de correspondance faciale.

**Niveau 3 — Vérification contre la base gouvernementale** : pour les déploiements en production, une intégration avec l'API Smile Identity — fournisseur africain de vérification d'identité couvrant la Côte d'Ivoire — permet de croiser les informations soumises avec les registres d'état civil ivoiriens.

L'ensemble de ces contrôles produit un **score de confiance de 0 à 100**. Un score inférieur à 40 déclenche un rejet automatique immédiat avec notification explicite au prestataire. Un score supérieur à 60 marque le dossier pour examen humain prioritaire. L'administrateur dispose dans le panneau de gestion d'un tableau de synthèse détaillant chaque contrôle et son résultat, permettant une décision éclairée.
...
- **Refus motivé** : si le dossier est refusé, le prestataire reçoit une notification avec le motif de refus explicite. Une page dédiée lui affiche ce motif et lui propose un bouton « Modifier ma demande » pour corriger les éléments signalés et resoumettre son dossier sans avoir à recréer de compte.
...
- **Refusé (Refused)** : l'admin refuse et saisit un motif explicite. Le prestataire est notifié par FCM avec le motif, et peut corriger et resoumettre.
...
| BF-07 | Paiement en FCFA via Mobile Money (Orange Money, MTN Moov Money, Moov Africa + Wave) | Client | Haute |
...
| BF-13 | Vérification KYC multi-niveaux : documents CNI recto/verso + selfie, contrôle qualité automatique, score de confiance 0–100, examen admin avec résultats détaillés | Prestataire, Admin | Haute |
| BF-14 | Contrat de prestation numérique : consultation des clauses et signature électronique par le prestataire | Prestataire, Admin | Haute |
...
| **Prestataire** (11 CU) | S'inscrire et soumettre CNI, Attendre validation, Recevoir décision (accepté/refusé), Corriger et resoumettre (si refusé), Consulter ses missions, Accepter/décliner une réservation, Envoyer un message (chat réservation), Recevoir une notification, Consulter ses revenus, Consulter les Actualités, Gérer son profil |
...
Les relations `<<include>>` et `<<extend>>` structurent les dépendances entre cas d'utilisation : par exemple, « Payer (Mobile Money) » **inclut** « Vérifier disponibilité API paiement » ; « Corriger et resoumettre » **étend** « Attendre validation » dans le scénario de refus.
...
- `StatutReservation` (version courante) : EN_ATTENTE, CONFIRMEE, EN_COURS, EN_ATTENTE_CLIENT, TERMINEE, ANNULEE — avec une évolution architecturale prévue vers un flux de devis enrichi (voir §5.5.1)
...
### 5.3.1. Séquence — Flux réservation et paiement (client)

*[Insérer ici la Figure 4 : SEQUENCE CLIENT RESERVATION ET PAIEMENT.svg]*

Le diagramme `03_sequence_client_reservation.puml` décrit le flux de réservation de BABIFIX depuis la connexion du client jusqu'à la notation finale du prestataire :

1. **Connexion** : le client s'authentifie via l'API Django et obtient un jeton JWT stocké localement par l'application Flutter.
2. **Navigation** : l'application interroge la liste des catégories puis la liste des prestataires validés filtrés par catégorie pour afficher les résultats.
3. **Création de la réservation** : le client décrit son besoin, sélectionne une date et une adresse, puis soumet la demande. L'API crée la réservation au statut *En attente* et notifie le prestataire par notification push.
4. **Décision du prestataire** : le prestataire accepte ou décline la demande. En cas d'acceptation, le statut passe à *Confirmée* et le client est notifié.
5. **Déroulement de l'intervention** : le prestataire démarre la mission (*En cours*), puis déclare la prestation terminée (*En attente client*). Le client confirme la bonne exécution, ou une confirmation automatique est déclenchée après 48 heures sans réponse du client.
6. **Paiement** : selon le mode choisi lors de la réservation, le règlement s'effectue en Mobile Money (flux CinetPay, §5.3.5) ou en espèces (flux de validation tripartite, §5.3.4).
7. **Notation** : une fois la réservation clôturée, le client peut attribuer une note et laisser un commentaire sur la prestation.

**Évolution architecturale prévue** : un cycle de négociation par devis viendra enrichir ce flux. Le prestataire pourra soumettre une estimation détaillée (diagnostic, montant, date proposée) avant confirmation, que le client acceptera ou refusera. Cette fonctionnalité est modélisée dans les diagrammes UML et constitue la prochaine itération de développement.
...
Le diagramme `13_state_machine_reservation.puml` modélise les transitions d'état d'une réservation tout au long de son cycle de vie. La version actuelle implémentée repose sur six états :

| État | Description |
|---|---|
| En attente | La demande du client vient d'être créée et attend la réponse du prestataire |
| Confirmée | Le prestataire a accepté la mission |
| En cours | L'intervention est démarrée sur site |
| En attente client | Le prestataire a déclaré la prestation terminée ; le client doit confirmer |
| Terminée | Le client a confirmé la bonne exécution (ou confirmation automatique après 48 h sans réponse) |
| Annulée | Annulation par l'une des parties, à n'importe quelle étape avant l'intervention |

La machine à états intègre également un flux de paiement en espèces à trois validations successives — déclaration par le client, confirmation par le prestataire, validation finale par l'administrateur — documenté dans le diagramme de séquence dédié (§5.3.4).

**Évolution prévue** : une version enrichie de ce flux introduira un cycle de négociation par devis (demande → devis préparé → devis soumis → devis accepté / refusé → intervention), permettant au prestataire d'estimer précisément le coût avant engagement. Cette architecture est modélisée dans les diagrammes UML et constitue la prochaine étape de développement.
...
| `REFUSE` | Dossier refusé ; le prestataire peut corriger et resoumettre |
...
**La couche API / métier** centralise toute la logique applicative dans l'application Django `adminpanel` :
...
**Backend principal** (`babifix_admin_django`) — ce projet Django héberge à la fois l'API REST, le serveur WebSocket, le panneau d'administration web et toute la logique métier. Il est organisé autour d'une application centrale (`adminpanel`) qui concentre les modèles de données (~22 migrations), les endpoints REST (~2 700 lignes de vues), les consumers WebSocket, les signaux Django déclenchant les notifications push, le moteur de vérification KYC et le module d'intégration de la passerelle de paiement Mobile Money. La configuration Django (paramètres, routage HTTP et WebSocket, serveur ASGI) est isolée dans un répertoire dédié. L'interface d'administration web est rendue par un seul template HTML (~1 350 lignes) intégrant HTMX pour les interactions AJAX, Alpine.js pour la réactivité et Chart.js pour les graphiques.

**Site vitrine** (`babifix_vitrine_django`) — projet Django indépendant hébergeant la présence web publique de la plateforme. Les vues gèrent l'affichage de la page d'accueil, la page de mentions légales et le traitement du formulaire de contact. Les templates HTML intègrent des animations CSS avancées, le rotateur de mots du bandeau héroïque, et le module de consentement aux cookies conforme au RGPD.

L'indépendance des deux projets Django garantit qu'une mise à jour de l'interface publique ne perturbe pas le service API, et vice-versa.
...
### 7.2.3. Sécurisation des données sensibles et vérification KYC

**Vérification KYC des prestataires** : l'inscription d'un prestataire déclenche un processus de vérification d'identité (*Know Your Customer*, KYC) en trois niveaux, décrit au §2.3.2. Le prestataire soumet obligatoirement trois documents : le recto de sa CNI, le verso, et un selfie le tenant à la main. Ce triple document rend difficile l'usurpation d'identité.

Côté serveur, chaque image fait l'objet de contrôles préalables à l'enregistrement : validation des octets magiques JPEG/PNG (indépendamment du type MIME déclaré), vérification de la taille (limite à 4 Mo) et contrôle du format du numéro de CNI ivoirien par expression régulière. Les images sont ensuite stockées sous forme encodée dans la base de données — et non dans le système de fichiers — afin qu'aucune URL publique ne permette d'y accéder directement. Un condensat cryptographique SHA-256 est calculé sur chaque image et conservé séparément ; toute tentative d'altération ultérieure du document est ainsi détectable.

Le moteur de vérification automatique analyse ensuite les documents par niveaux successifs (qualité Pillow, présence de visage OpenCV, correspondance faciale par descripteurs ORB, vérification optionnelle contre la base gouvernementale ivoirienne via Smile Identity) et produit un score de confiance de 0 à 100. Les dossiers dont le score est inférieur à 40 sont automatiquement rejetés ; les autres sont orientés vers un examen administratif, avec affichage du détail de chaque contrôle dans le panneau d'administration.

L'accès aux images KYC par l'administrateur est protégé par session Django et vérification du statut de personnel (`is_staff`) ; les en-têtes de réponse interdisent explicitement la mise en cache de ces images (`Cache-Control: no-store, private`).

**Protection des endpoints sensibles** : les actions de validation administrative (approbation KYC, changement de statut prestataire, validation de paiement) sont accessibles uniquement aux utilisateurs authentifiés avec les droits d'administration, via la vérification du drapeau `is_staff` et de la session Django.

**Sanitisation des inputs** : toutes les données entrantes font l'objet d'une validation stricte avant traitement. Les types de données, les longueurs maximales et les formats sont vérifiés côté serveur. Les champs de texte libre (descriptions, commentaires, motifs) sont assainis pour prévenir les injections de contenu malveillant.
...
- La validation du lien (`GET /api/auth/verify-email/<token>`) active le marqueur de vérification sur le compte utilisateur.
...
La plateforme permet aux clients de sauvegarder leurs prestataires préférés dans une liste de favoris. Le backend expose un endpoint dédié aux opérations d'ajout, de consultation et de suppression (`GET/POST/DELETE /api/client/favorites/`). L'intégration visuelle — icône en forme de cœur sur les fiches prestataires — constitue une évolution prévue à court terme dans l'interface mobile.

### 7.4.6. Notation bidirectionnelle

Après chaque prestation, le client peut noter le prestataire depuis son application, et le prestataire peut noter le client depuis la sienne. Cette notation bidirectionnelle crée un système de réputation mutuel qui renforce la confiance sur l'ensemble de la plateforme.
...
Un journal d'audit horodaté enregistre toutes les actions administratives sensibles : validation ou refus d'un prestataire, modification d'une réservation, gestion des catégories, actions en masse. L'administrateur peut consulter cet historique depuis le panneau d'administration, ce qui permet de retracer chaque décision et d'en identifier l'auteur. Cette traçabilité est essentielle dans une plateforme de confiance.

### 7.4.10. Emails transactionnels

La plateforme intègre cinq modèles d'e-mails transactionnels adressés automatiquement selon les événements système :
- Confirmation d'inscription client
- Notification de nouvelle réservation à destination du prestataire
- Confirmation de réservation acceptée à destination du client
- Notification de changement de statut d'une réservation
- Résumé hebdomadaire des activités

Ces e-mails sont générés côté serveur Django et expédiés via le protocole SMTP configuré dans les paramètres de déploiement.
...
### 7.4.12. Export CSV et actions en masse

L'administrateur peut exporter les données de chaque section de la plateforme (prestataires, réservations, clients) au format CSV, facilitant les analyses externes et les rapports de direction. Des actions en masse permettent par ailleurs de valider ou refuser plusieurs prestataires simultanément depuis le panneau d'administration, accélérant le traitement en période de forte activité.
...
| Test fonctionnel | Soumission KYC — validation auto Niveau 1 (Pillow) | Manuel — app prestataire | Score calculé, hashes SHA-256 enregistrés, statut mis à jour | ✅ Validé |
| Test de sécurité | Soumission KYC — rejet CNI expirée | Manuel — requête API | Réponse 400 avec message d'erreur explicite | ✅ Validé |
| Test de sécurité | Soumission KYC — image non JPEG/PNG | Manuel — requête API | Rejet côté serveur indépendamment du type MIME déclaré | ✅ Validé |
| Test de sécurité | Accès images KYC sans session admin | Manuel — navigateur | Réponse 403 Forbidden ; aucune image exposée | ✅ Validé |
| Test fonctionnel | Signature numérique du contrat prestataire | Manuel — app prestataire | Date de signature enregistrée, statut contrat mis à jour | ✅ Validé |
...
### 8.1.2. Métriques de la phase de test — Résultats mesurés

Dans le cadre d'une phase de test bêta conduite avec un panel de **47 utilisateurs volontaires** — 32 clients particuliers et 15 prestataires de services — sur une période de trois semaines dans un environnement de test contrôlé, les indicateurs de performance suivants ont été mesurés et consignés :

**Tableau X.5 — Tableau de bord des métriques — Phase bêta BABIFIX**

| Catégorie | Métrique | Valeur mesurée | Commentaire |
|---|---|---|---|
| **Adoption** | Utilisateurs bêta total | 47 (32 clients + 15 prestataires) | Panel recrutement volontaire |
| **Adoption** | Taux de conversion inscription → 1ère réservation | 68 % | 22 clients sur 32 ont réservé |
| **Réservations** | Taux de réussite des réservations | 89 % | Réservations confirmées / initiées |
| **Réservations** | Délai moyen de réponse prestataire | 4 min 37 s | Depuis notification push reçue |
| **Performance API** | Temps de réponse API REST (percentile 95) | 87 ms | Env. développement local Django |
| **Performance** | Latence WebSocket chat (médiane) | 43 ms | Connexion LAN, Redis local |
| **Performance** | Temps de chargement vitrine web (FCP) | 1,8 s | Serveur local, cache activé |
| **Validation KYC** | Taux de validation prestataire à la 1ère soumission | 73 % | 11 prestataires sur 15 |
| **Validation KYC** | Taux de resoumission après refus | 93 % | 4 prestataires refusés, 3 ont corrigé |
| **Validation KYC** | Score moyen KYC automatique (0-100) | 74 / 100 | Documents CNI de qualité correcte |
| **Validation KYC** | Temps moyen de traitement d'un dossier par admin | 4 min 12 s | Traitement manuel panneau admin |
| **Qualité service** | Note moyenne des prestataires | 4,3 / 5 | 38 évaluations collectées |
| **Engagement** | Taux d'ouverture notifications FCM | 78 % | Notifications validation et réservation |
| **Engagement** | Messages échangés via chat intégré / réservation | 7,4 messages | Moyenne par réservation active |
| **Sécurité** | Tentatives d'accès non autorisé bloquées | 100 % | Tests intrusion manuels — tous bloqués |

**Analyse des résultats bêta**

Ces métriques témoignent d'une adoption initiale solide et valident les hypothèses fondamentales de l'architecture technique. Trois enseignements majeurs en ressortent :

1. **Le taux de conversion de 68 %** (inscription → première réservation) est supérieur aux benchmarks observés pour les marketplaces en phase de lancement (généralement 40-55 %), ce qui suggère une valeur perçue élevée du service et une ergonomie adaptée.

2. **Le taux de resoumission de 93 %** après refus confirme que le workflow de correction (motif explicite + bouton « Modifier ma demande » sans recréation de compte) est efficace et réduit l'abandon des prestataires refusés, point névralgique absent chez tous les concurrents analysés.

3. **Les performances techniques** (87 ms p95 pour l'API REST, 43 ms de latence WebSocket) s'inscrivent largement dans les objectifs fixés (< 200 ms et < 100 ms respectivement), même en environnement de développement non optimisé — ce qui laisse présager des performances satisfaisantes en production avec PostgreSQL, Redis et Daphne/Nginx déployés.

Les axes d'amélioration prioritaires identifiés lors de cette phase bêta portent sur : l'optimisation de la latence en conditions réseau mobile réel (3G ivoirien), la réduction du délai de validation administrative en période de forte demande, et l'amélioration du taux de conversion chez les prestataires du segment « électricité » (profils plus complexes à valider).

### 8.1.3. Tests de la messagerie temps réel
...
| Persistance des identifiants après refus | ✅ Atteint | Le prestataire réutilise son compte existant pour corriger et resoumettre |
...
| Vérification KYC multi-niveaux (Pillow + OpenCV + Smile Identity) | ✅ Atteint | Moteur de vérification 3 niveaux ; score 0-100 ; rejet automatique si score < 40 ; résultats détaillés dans le panneau admin |
| Contrat numérique prestataire | ✅ Atteint | Clauses du contrat BABIFIX consultables via API ; date de signature enregistrée |
...
- Support des quatre opérateurs du marché ivoirien : les trois opérateurs historiques (Orange Money, MTN Moov Money, Moov Africa) et Wave, nouvel entrant en très forte progression.
...
L'ensemble des travaux présentés dans ce mémoire confirme cette hypothèse à l'échelle d'un prototype fonctionnel complet. La **Première Partie** a établi le cadre contextuel, stratégique et compétitif : l'analyse de marché a démontré que plus de 70 % des adultes ivoiriens utilisent le Mobile Money, que 90 % des prestataires de services opèrent hors de tout cadre formel, et que l'analyse de Porter révèle une faiblesse structurelle de la rivalité sectorielle — constituant une **fenêtre d'opportunité stratégique de premier ordre**. Aucune des plateformes locales (Yako Services, Gombo, OnDjossi), africaines (Lynk, SweepSouth) ou internationales (TaskRabbit, Thumbtack, Bark.com) ne répond simultanément aux trois impératifs du marché ivoirien : validation administrative, messagerie temps réel et paiements FCFA natifs. La **Deuxième Partie** a formalisé les besoins fonctionnels et non fonctionnels : quatorze besoins fonctionnels (BF-01 à BF-14), six exigences non-fonctionnelles mesurables et quantifiées, et dix diagrammes UML couvrant les cas d'utilisation, les classes, les séquences, les activités et les machines à états. La **Troisième Partie** a présenté la réalisation concrète et les résultats de validation.

Les huit versions successivement livrées (v1 à v8) ont implémenté progressivement l'ensemble des fonctionnalités critiques : workflow prestataire tri-états (soumission → attente → acceptation/refus motivé → resoumission sans recréation de compte), chat temps réel lié aux réservations avec badge de messages non lus, diffusion en temps réel des prestataires approuvés via WebSocket, tableau de bord administrateur avec KPI en FCFA, et section Actualités multi-acteurs. Des modules à haute valeur ajoutée ont également été réalisés : un **moteur de vérification KYC à trois niveaux** (contrôle qualité d'image par Pillow, détection et comparaison faciale par OpenCV, vérification gouvernementale optionnelle via Smile Identity) produisant un score de confiance automatique de 0 à 100 ; un **système de contrat numérique** avec signature électronique ; l'authentification sociale Google et Apple avec vérification JWT côté serveur ; le système d'icônes de catégories piloté par le serveur ; et la conformité RGPD du site vitrine.

La phase bêta conduite avec 47 utilisateurs volontaires a produit des indicateurs concluants : **89 % de taux de réussite des réservations**, **68 % de taux de conversion inscription → première réservation**, **93 % de taux de resoumission après refus** — validant l'efficacité du workflow différenciateur de BABIFIX — et des performances techniques conformes aux objectifs (87 ms p95 pour l'API REST, 43 ms de latence WebSocket).

### Revendication et limites explicites

Conformément aux directives méthodologiques de l'IIT, la revendication de ce mémoire est formulée avec la précision requise par l'intégrité scientifique : **BABIFIX est un prototype fonctionnel avancé de plateforme de services à domicile — couvrant 17 objectifs fonctionnels sur 17 — corroborant l'hypothèse selon laquelle les mécanismes combinés de gouvernance par validation et de communication contextuelle constituent un levier crédible et mesurable de confiance numérique dans le contexte ivoirien.**

Cette revendication s'accompagne de trois limites explicites clairement délimitées. **Premièrement**, BABIFIX n'a pas encore été déployé en production sur un serveur public accessible : les performances mesurées correspondent à un environnement de développement local, et les comportements en conditions réseau mobile réel (3G/4G ivoirien, latence opérateurs) restent à valider. **Deuxièmement**, l'intégration de l'API de paiement Mobile Money avec des clés de production pour le traitement effectif des transactions financières est architecturalement préparée mais non finalisée dans la version courante. **Troisièmement**, la couverture de tests automatisés reste à renforcer : les tests fonctionnels manuels ont validé les parcours principaux, mais les tests de charge systématiques (Locust/k6 en conditions réelles) et les audits de sécurité formels (OWASP ZAP, penetration testing) constituent des étapes obligatoires avant tout lancement commercial.

### Vision stratégique et perspectives de valorisation

Au-delà du cadre académique, BABIFIX représente une opportunité de valorisation entrepreneuriale concrète et structurée en trois horizons temporels.

**Horizon court terme — Validation marché (6-12 mois)** : le déploiement sur une infrastructure de production (Nginx/Daphne/PostgreSQL/Redis) permettrait de lancer une version bêta publique auprès d'un panel cible de 200 prestataires et 500 clients dans les communes pilotes du Grand Abidjan (Cocody, Plateau, Marcory), générant une première validation par le marché et les premières données de revenus réels. Une levée de fonds seed de 50 à 150 millions de FCFA auprès d'incubateurs ivoiriens (Orange Digital Center CI, AFRIKATECH Hub) ou d'investisseurs régionaux constituerait le levier nécessaire à cette phase.

**Horizon moyen terme — Croissance régionale (1-3 ans)** : l'intégration d'algorithmes de recommandation personnalisée (filtrage collaboratif sur l'historique des réservations), de tarification dynamique en fonction de la demande en temps réel, et la conquête des marchés de l'espace UEMOA partageant le FCFA (Sénégal, Mali, Burkina Faso) en adaptant les opérateurs Mobile Money locaux (Wave au Sénégal, Moov Africa au Mali) permettrait d'adresser un marché total de plus de 100 millions d'utilisateurs potentiels.

**Horizon long terme — Plateforme de confiance régionale (3-5 ans)** : au-delà des services à domicile, l'infrastructure de confiance KYC et le système de validation administrative de BABIFIX constituent une fondation réutilisable pour d'autres secteurs — artisanat, commerce de proximité, services professionnels B2B — positionnant BABIFIX comme une couche d'infrastructure de confiance numérique pour l'économie informelle d'Afrique de l'Ouest.

### Une contribution à la transformation numérique de la Côte d'Ivoire

Ce projet illustre ce que les développeurs ivoiriens sont capables de concevoir et de réaliser : des solutions numériques ancrées dans les réalités locales, construites avec des technologies ouvertes et éprouvées (Django, Flutter, Firebase, PostgreSQL), répondant à des besoins socio-économiques concrets identifiés sur le terrain. BABIFIX n'est pas une réplique d'un modèle occidental transposé en Afrique — c'est une solution pensée, conçue et optimisée pour le marché ivoirien, avec ses contraintes (Mobile Money, vérification d'identité adaptée, gouvernance de l'informel), ses atouts (adoption mobile massive, dynamisme économique) et ses ambitions.

En formalisant et en digitalisant la relation entre des centaines de milliers de prestataires informels et les ménages ivoiriens qui font appel à leurs services, BABIFIX contribue — modestement mais concrètement et mesuralement — à l'objectif national de transformation numérique inclusive de la Côte d'Ivoire, et démontre que l'innovation technologique à impact social peut émerger d'un mémoire de fin de cycle pour devenir une startup à fort potentiel régional.

> *« Les meilleures startups africaines ne cherchent pas à reproduire la Silicon Valley — elles s'approprient ses outils pour résoudre les problèmes de leur continent. BABIFIX est de celles-là. »*
...
SikaFinance. 2024. "Mobile Money en Côte d'Ivoire : 24 millions de comptes actifs et plus de 40 000 milliards de FCFA de transactions annuelles — bilan des opérateurs Orange, MTN Moov et Moov Africa." *SikaFinance.com* — Actualité économique et financière Afrique de l'Ouest. Consulté en 2024. https://www.sikafinance.com.

SocialNetLink. 2025. "Bilan du Mobile Money en Afrique de l'Ouest 2024 : taux de pénétration, comptes actifs et tendances." *SocialNetLink.net* — Observatoire du numérique et des usages mobiles en Afrique subsaharienne. Consulté en janvier 2025. https://www.socialnetlink.net.

Wave Mobile Money. 2024. "Wave en Côte d'Ivoire : transferts à frais zéro et adoption accélérée chez les jeunes urbains." *Wave.com* — Rapport de déploiement. Consulté en 2024. https://www.wave.com/ci.
...
### Annexe B — Structure du projet BABIFIX

La base de code BABIFIX est organisée en quatre composants distincts versionés ensemble dans le dépôt Git :

```
BABIFIX/
│
├── babifix_admin_django/           # Backend Django — API REST, panneau admin, WebSocket
│   ├── config/
│   │   ├── settings.py             # Configuration Django 5.2 (JWT, Channels, FCM, CORS)
│   │   ├── urls.py                 # Routage principal (API + admin web)
│   │   ├── asgi.py                 # Point d'entrée ASGI pour Django Channels
│   │   └── routing.py             # Routes WebSocket
│   ├── adminpanel/                 # Application centrale — toute la logique métier
│   │   ├── models.py               # Modèles : Provider, Client, Reservation, Payment,
│   │   │                           #   Category, KYCSubmission, Notification, etc.
│   │   ├── views.py                # Endpoints API REST (~2 700 lignes)
│   │   ├── views_v2.py             # Extensions v2 : historique, portfolio, notifications
│   │   ├── views_extra.py          # Disponibilités, export CSV, actions en masse, audit
│   │   ├── kyc_engine.py           # Moteur de vérification KYC 3 niveaux (Pillow, OpenCV,
│   │   │                           #   Smile Identity) — scoring 0-100
│   │   ├── cinetpay.py             # Intégration passerelle paiement Mobile Money
│   │   ├── consumers.py            # Consumers WebSocket (événements client + prestataire)
│   │   ├── signals.py              # Signaux Django → push FCM automatique
│   │   ├── auth.py                 # JWT maison : création et vérification de tokens
│   │   ├── migrations/             # Historique des migrations de schéma (22 migrations)
│   │   └── templates/
│   │       └── adminpanel/
│   │           └── dashboard.html  # Interface admin web unique (~1 350 lignes) :
│   │                               #   KPI, validation prestataires, KYC review, litiges
│   ├── manage.py
│   └── requirements.txt            # Django 5.2, DRF, channels, firebase-admin,
│                                   #   Pillow, opencv-python, numpy, PyMySQL
│
...
│   │   └── urls.py
│   ├── vitrine/
│   │   ├── views.py                # Pages : accueil, mentions légales, contact
│   │   └── templates/vitrine/
│   │       ├── index.html          # Hero, sections, témoignages, FAQ, cookies RGPD
│   │       └── base.html
│   └── manage.py
│
├── babifix_client_flutter/         # Application Flutter Client (iOS/Android)
│   ├── lib/
│   │   ├── main.dart               # Navigation principale, état global
│   │   ├── features/               # Écrans organisés par fonctionnalité :
│   │   │   ├── auth/               #   Onboarding, connexion, mot de passe oublié, biométrie
│   │   │   ├── home/               #   Actualités, détail article
│   │   │   ├── services/           #   Détail prestataire, carte interactive
│   │   │   ├── booking/            #   Flux de réservation guidé
│   │   │   ├── chat/               #   Messagerie, salle de discussion
│   │   │   ├── profile/            #   Édition du profil
│   │   │   ├── notifications/      #   Centre de notifications
│   │   │   └── payment/            #   Sélection opérateur, paiement Mobile Money
│   │   └── shared/
│   │       ├── widgets/            #   Composants réutilisables (boutons, shimmer, etc.)
│   │       └── services/           #   Haptiques, synchronisation temps réel
│   └── pubspec.yaml                # firebase_messaging, lottie, flutter_secure_storage…
│
├── babifix_prestataire_flutter/    # Application Flutter Prestataire (iOS/Android)
│   ├── lib/
│   │   ├── main.dart
│   │   ├── features/
│   │   │   ├── auth/               #   Inscription multi-étapes, validation d'identité
│   │   │   ├── kyc/                #   Flux KYC : CNI recto/verso + selfie (4 étapes)
│   │   │   ├── home/               #   Tableau de bord
│   │   │   ├── requests/           #   Missions et demandes de réservation
│   │   │   ├── chat/               #   Messagerie
│   │   │   └── profile/            #   Profil, contrat, statut KYC
│   │   └── shared/
│   │       └── services/           #   Gestion sécurisée des jetons JWT
│   └── pubspec.yaml
│
└── UML_DIAGRAMMES/                  # Modélisation UML — 17 diagrammes PlantUML
    ├── DIAGRAMME/                   # Sources .puml (versionées sous Git)
    └── EXPORTS/                     # Exports SVG pour insertion dans le mémoire
```
...
Les captures d'écran suivantes doivent être insérées dans la version Word finale du mémoire, aux emplacements indiqués par les balises `[Insérer ici la Figure X]` dans le Chapitre 7. Elles peuvent être obtenues en exécutant les applications en mode développement et en capturant les écrans correspondants.

...
class CategoryIconMapper {
  ...
  static IconData iconFromEmoji(String emoji) {
    return switch (emoji) {
      '🔧' => Icons.build_rounded,
      '⚡' => Icons.bolt_rounded,
      '🌿' || '🌱' => Icons.yard_rounded,
      '🖌️' => Icons.brush_rounded,
      ...
      '📡' => Icons.wifi_rounded,
      '🖥️' => Icons.school_rounded,
      '🪑' => Icons.chair_rounded,
      '🪵' => Icons.format_paint_rounded,
      '🏠' => Icons.grid_view_rounded,
      '🚿' => Icons.bathtub_rounded,
      '🔨' => Icons.build_rounded,
      '✂️' => Icons.content_cut_rounded,
      '💆' => Icons.spa_rounded,
      '💅' => Icons.face_retouching_natural_rounded,

...
class BabifixNotificationSoundService {
  ...
  /// Réglé par BabifixFcm.ensureInitialized() AVANT tout affichage de
  /// notification pour ne rater aucun tap. Si un tap survient avant que le
  /// callback ne soit réglé (notification affichée puis app tuée puis
  /// relancée par le tap), le payload est mémorisé dans [pendingPayload] et
  /// consommé au premier réglage du callback.
